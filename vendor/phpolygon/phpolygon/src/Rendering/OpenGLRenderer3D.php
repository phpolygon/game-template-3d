...
class OpenGLRenderer3D implements Renderer3DInterface
{
    ...
    public function render(RenderCommandList $commandList): void
    {
        ...
        // Weather surface defaults (clear sky)
        $this->setUniformFloat('u_rain_intensity', 0.0);
        $this->setUniformFloat('u_snow_coverage', 0.0);
        $this->setUniformFloat('u_temperature', 20.0);
        $this->setUniformFloat('u_dew_wetness', 0.0);
        $this->setUniformFloat('u_storm_intensity', 0.0);
        ...
        foreach ($commandList->getCommands() as $command) {
            ...
            } elseif ($command instanceof Command\SetWeatherUniforms) {
                $this->setUniformFloat('u_rain_intensity', $command->rainIntensity);
                $this->setUniformFloat('u_snow_coverage', $command->snowCoverage);
                $this->setUniformFloat('u_temperature', $command->temperature);
                $this->setUniformFloat('u_dew_wetness', $command->dewWetness);
                $this->setUniformFloat('u_storm_intensity', $command->stormIntensity);
            }
        }
